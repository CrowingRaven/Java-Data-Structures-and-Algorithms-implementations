...
public class Q1C {
    ...
    public static ArrayList<Integer> initHybridQuickSort(ArrayList<Integer> list) {
        ArrayList<Integer> listToSort = new ArrayList<>(list);

        hybridQuickSort(listToSort, 0, listToSort.size() - 1);
        return listToSort;
    }

    private static void hybridQuickSort(ArrayList<Integer> list, int low, int high) {
        int threshold = 16;
        if (high - low + 1 <= threshold) {
            ...
            if (low < high) {
                ...
                hybridQuickSort(list, low, pivotIndex - 1);
                hybridQuickSort(list, pivotIndex + 1, high);
            }
        }
    }
    ...
    private static void insertionSort(ArrayList<Integer> list, int low, int high) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> sortedMonday = initHybridQuickSort(randMonday);
        System.out.println("Monday's list sorted");
        ArrayList<Integer> sortedTuesday = initHybridQuickSort(randTuesday);
        System.out.println("Tuesday's list sorted");
        ArrayList<Integer> sortedWednesday = initHybridQuickSort(randWednesday);
        System.out.println("Wednesday's list sorted");
        ArrayList<Integer> sortedThursday = initHybridQuickSort(randThursday);
        System.out.println("Thursday's list sorted");
        ArrayList<Integer> sortedFriday = initHybridQuickSort(randFriday);
        System.out.println("Friday's list sorted");
        ArrayList<Integer> sortedSaturday = initHybridQuickSort(randSaturday);
        System.out.println("Saturday's list sorted");
        ArrayList<Integer> sortedSunday = initHybridQuickSort(randSunday);
